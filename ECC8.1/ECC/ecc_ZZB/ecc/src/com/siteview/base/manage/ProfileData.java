...
public class ProfileData implements Serializable
{
	...
	private String m_SpecialLoginName;
	...
	public Map<String, INode>		m_inode;
	...
	public ProfileData( String LoginName, String session, Map<String, String> ldata)
	{
	...
	public ProfileData( String LoginName, String specialLoginName,String session, Map<String, String> ldata)
	{
		//this.ServerData = sd;
		this.m_LoginName = LoginName;
		this.m_SpecialLoginName = specialLoginName;
		this.m_session = session;
		m_login_data.putAll(ldata);
	}
	...
	{
		return this.m_SpecialLoginName;
	}
...
//		ArrayList<String> a= new ArrayList<String>(m_tree_change_id);
	...
	public void updateTreeInfo()
	{
		...
		{
			INode node= ServerData.getNode(m_LoginName, id);
			if(node==null)
				continue;
	...
	{
		SeNode[] s = ServerData.getSe(m_LoginName);
		if(s==null)
			return;
		int size = s.length;
		for (int i = 0; i < size; ++i)
...
//	}
	...
	private boolean INodeChange(INode n1, INode n2) {
		...
		if (n1.getStatus() == null && n2.getStatus() == null){
		
		}else if (n1.getStatus() != null && n2.getStatus() == null){
			return true;
		}else if (n1.getStatus() == null && n2.getStatus() != null){
			return true;
		}else if (n1.getStatus().equals(n2.getStatus()) == false){
			return true;
		}

		if (n1.getType() == null && n2.getType() == null){
			
		}else if (n1.getType() != null && n2.getType() == null){
			return true;
		}else if (n1.getType() == null && n2.getType() != null){
			return true;
		}else if (n1.getType().equals(n2.getType()) == false){
			return true;
		}
		...
		if (n1.getName() == null && n2.getName() == null){
			...
			return true;
		}else if (n1.getName().equals(n2.getName()) == false){
			return true;
		}
	...
	private boolean SeInfoChange(INode node)
	{
		...
		Map<String, String> inivalue= ServerData.getIniValue(m_LoginName, e.getSvId());
		if(inivalue==null)
			return false;
		e.setIniValue(inivalue);
		e.setRawMap(ServerData.getRawMapClone(e.getSvId()));

...
//
	...
	public int get_sub_entity_sum(Session session)
	{
		if(m_raw_map==null)
			return -1;
		String v= m_raw_map.get("sub_entity_sum");
		if(v==null)
			return -1;
	...
	public int get_sub_monitor_sum(Session session)
	{
		if(m_raw_map==null)
			return -1;
		String v= m_raw_map.get("sub_monitor_sum");
		if(v==null)
			return -1;
		return new Integer(v);
	}
	public int get_sub_monitor_disable_sum(Session session)
	{
		if(m_raw_map==null)
			return -1;
		String v= m_raw_map.get("sub_monitor_disable_sum");
		if(v==null)
			return -1;
		return new Integer(v);
	}
	public int get_sub_monitor_error_sum(Session session)
	{
		if(m_raw_map==null)
			return -1;
		String v= m_raw_map.get("sub_monitor_error_sum");
		if(v==null)
			return -1;
		return new Integer(v);
	}
	public int get_sub_monitor_warning_sum(Session session)
	{
		if(m_raw_map==null)
			return -1;
		String v= m_raw_map.get("sub_monitor_warning_sum");
		if(v==null)
			return -1;
		return new Integer(v);	
	}
	public int get_sub_monitor_ok_sum(Session session)
	{
		if(m_raw_map==null)
			return -1;
		String v= m_raw_map.get("sub_monitor_ok_sum");
		if(v==null)
			return -1;
		return new Integer(v);	
	}

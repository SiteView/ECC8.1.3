...
/*			if (LDAPProviderUrl.getValue() != null && !LDAPProviderUrl.getValue().isEmpty()
	...
	/*
	 * add role manage for city
	 * xiao
	 */
	public void onRole(Event event) throws Exception{
		System.out.println("权限界面" );
		...
		Window win = (Window) Executions.createComponents("/main/setting/role/addRole.zul", null, null);
		win = (Window) Executions.createComponents("/main/setting/role/addRole.zul", null, null);
		win.doModal();

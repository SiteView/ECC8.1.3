...
#define DFLAGPAT_VIEWFORM "-FQMUGXWy#i@0nKg~%"	/* display things editable with dialog box; version filtering */
#define DFLAGPAT_VIEWFORM_MENUABLE "-FQMUGXWy#i@40nKg~%"	/* display things showable on the menu */
#define DFLAGPAT_VIEWFORM_ALL_VERSIONS "-FQMUGXWy#i@Kg~%" /* display things editable with dialog box; no version filtering (for design) */
...
#define DFLAGPAT_QUERYBYFORM "-DU40ny"		/* display forms that appear in query by form; version filtering */

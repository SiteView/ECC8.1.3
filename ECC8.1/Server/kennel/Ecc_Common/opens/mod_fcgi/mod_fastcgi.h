...
#define FCGI_DEFAULT_MAX_PROCS  2500         /* maximum number of processes that
...
#define FCGI_DEFAULT_MAX_CLASS_PROCS 500    /* maximum number of processes that
...
#define FCGI_DEFAULT_KILL_INTERVAL 1440 
...
#define FCGI_DEFAULT_START_PROCESS_DELAY 20 /* specifies the maximum number of

...
CCXX_EXPORT(char*) b64Encode(const char *source, char *dest, size_t limit)
{
...
CCXX_EXPORT(char*) urlEncode(const char *source, char *dest, size_t max)	
{
 ...
 * @param src     source string
 */
CCXX_EXPORT(String) b64Decode(const String& src)
{
 ...
 */
CCXX_EXPORT(String) b64Encode(const unsigned char *src, size_t srcsize)
{
 ...
 */
CCXX_EXPORT(size_t) b64Decode(const String& src,
  unsigned char *dst, size_t dstsize)
{

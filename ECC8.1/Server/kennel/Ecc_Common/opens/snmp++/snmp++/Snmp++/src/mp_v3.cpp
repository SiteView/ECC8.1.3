/*_############################################################################
  ...
  _##  
  _##########################################################################*/
char mp_v3_cpp_version[]="@(#) SNMP++ $Id: mp_v3.cpp,v 1.11 2004/07/04 19:12:09 katz Exp $";
...
{
 // printf("securityLevel :%d  build func \r\n",securityLevel);
 ...
 // printf("securityLevel :%d msgFlags :%d \r\n",securityLevel,msgFlags);

...
#ifndef QWEB_FCGIRECORD_H_
#define QWEB_FCGIRECORD_H_
...
class __declspec(dllexport) FCGIRecord
{
public:
  FCGIRecord();
  ~FCGIRecord();
  ...
  void getParamPair(std::string& name, std::string& value) const;

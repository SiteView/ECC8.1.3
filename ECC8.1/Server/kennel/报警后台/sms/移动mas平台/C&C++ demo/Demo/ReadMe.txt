========================================================================
       MICROSOFT FOUNDATION CLASS LIBRARY : VCDemo
========================================================================


AppWizard has created this VCDemo application for you.  This application
not only demonstrates the basics of using the Microsoft Foundation classes
but is also a starting point for writing your application.

This file contains a summary of what you will find in each of the files that
make up your VCDemo application.
...
res\VCDemo.ico
    ...
    icon is included by the main resource file VCDemo.rc.
...
VCDemoDlg.h, VCDemoDlg.cpp - the dialog
    These files contain your CVCDemoDlg class.  This class defines
    the behavior of your application's main dialog.  The dialog's
    template is in VCDemo.rc, which can be edited in Microsoft
	Visual C++.

DlgProxy.h, DlgProxy.cpp - the automation object
    These files contain your CVCDemoDlgAutoProxy class.  This class
...
StdAfx.h, StdAfx.cpp
    ...
    named VCDemo.pch and a precompiled types file named StdAfx.obj.

========================================================================
    MICROSOFT 基础类库 : UniversalMonitor 项目概况
========================================================================


应用程序向导已为您创建了此 UniversalMonitor DLL。此 DLL 不仅
说明了使用 Microsoft 基础类的基础，而且
也是编写 DLL 的起点。

此文件包含组成 UniversalMonitor DLL
的每个文件的内容摘要。

UniversalMonitor.vcproj
...
UniversalMonitor.h
    这是 DLL 的主头文件。它声明了
    CUniversalMonitorApp 类。

UniversalMonitor.cpp
    这是主 DLL 源文件。它包含了类 CUniversalMonitorApp。
UniversalMonitor.rc
...
res\UniversalMonitor.rc2
    此文件包含不由 Microsoft 
    Visual C++ 编辑的资源。您应将不能由
    资源编辑器编辑的所有资源放置在此文件中。

UniversalMonitor.def
...
StdAfx.h、StdAfx.cpp
    这些文件用于生成名为 UniversalMonitor.pch

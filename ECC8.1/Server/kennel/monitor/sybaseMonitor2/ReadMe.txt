========================================================================
    MICROSOFT 基础类库 : sybaseMonitor2 项目概况
========================================================================


应用程序向导已为您创建了此 sybaseMonitor2 DLL。此 DLL 不仅
说明了使用 Microsoft 基础类的基础，而且
也是编写 DLL 的起点。

此文件包含组成 sybaseMonitor2 DLL
的每个文件的内容摘要。

sybaseMonitor2.vcproj
...
sybaseMonitor2.h
    这是 DLL 的主头文件。它声明了
    CsybaseMonitor2App 类。

sybaseMonitor2.cpp
    这是主 DLL 源文件。它包含了类 CsybaseMonitor2App。
sybaseMonitor2.rc

      ...
      **********************************************************************
       ...
       01 SQLM-APPLINFO.
          ...
          05 APPL-ID                 PIC X(32).
          05 SEQUENCE-NO             PIC X(4).
          05 AUTH-ID                 PIC X(20).
          05 CLIENT-NNAME            PIC X(20).
          05 CLIENT-PRDID            PIC X(20).
          05 INPUT-DB-ALIAS          PIC X(20).
          05 CLIENT-DB-ALIAS         PIC X(20).
          05 DB-NAME                 PIC X(20).
          05 DB-PATH                 PIC X(256).
          05 RESERVED                PIC X(20).
      ...
      *   SQLM-DBMON-VERSION2  Client Identification Information
          05 EXECUTION-ID            PIC X(20).
          05 CORR-TOKEN              PIC X(32).
      ...
      **********************************************************************
       ...
       01 SQLM-DCS-APPLINFO.
          ...
          05 CLIENT-DB-ALIAS         PIC X(20).
          05 DB-NAME                 PIC X(20).
          05 HOST-PRDID              PIC X(20).
          05 OUTBOUND-APPL-ID        PIC X(32).
          05 OUTBOUND-SEQUENCE-NO    PIC X(4).
      ...
      **********************************************************************
       ...
       01 SQLM-DCS-APPLID-INFO.
          ...
          05 CLIENT-NNAME            PIC X(20).
          05 CLIENT-PRDID            PIC X(20).
          05 GW-DB-ALIAS             PIC X(20).
          05 EXECUTION-ID            PIC X(20).
          05 OUTBOUND-COMM-ADDRESS   PIC X(32).
          05 INBOUND-COMM-ADDRESS    PIC X(32).
          05 OUTBOUND-COMM-PROTOCOL  PIC 9(4) COMP-5.
          05 CLIENT-PLATFORM         PIC 9(4) COMP-5.
          05 CLIENT-PROTOCOL         PIC 9(4) COMP-5.
          05 FILLER-B                PIC X(2).
          05 DCS-DB-NAME             PIC X(20).
          05 HOST-DB-NAME            PIC X(20).
          05 HOST-PRDID              PIC X(20).
          05 OUTBOUND-APPL-ID        PIC X(32).
          05 OUTBOUND-SEQUENCE-NO    PIC X(4).
          05 DCS-APPL-STATUS         PIC 9(9) COMP-5.
      ...
      **********************************************************************
       ...
       01 SQLM-TPMON-INFO.
          ...
          05 INFO-TYPE                   PIC X.
          05 FILLER                      PIC X(3).
          05 TPMON-CLIENT-USERID         PIC X(20).
          05 TPMON-CLIENT-WKSTN          PIC X(20).
          05 TPMON-CLIENT-APP            PIC X(20).
      ...
      * SQLM_DBMON_VERSION5  Agent Information
          ...
          05 PRODUCT-NAME            PIC X(32).
          05 COMPONENT-ID            PIC X(20).
          05 SERVICE-LEVEL           PIC X(8).
      ...
      *   Locking information
          ...
          05 LOCK-WAIT-START-TIME.
             10 SECONDS              PIC 9(9) COMP-5.
             10 MICROSEC             PIC 9(9) COMP-5.
          05 APPL-ID-HOLDING-LK      PIC X(32).
          05 SEQUENCE-NO-HOLDING-LK  PIC X(4).
      ...
      *   SQLM-DBMON-VERSION2  Lock Wait Information
          ...
          05 TABLE-SCHEMA            PIC X(20).
          05 TABLESPACE-NAME         PIC X(20).
      ...
      **********************************************************************
       ...
       01 SQLM-EV-LOG-HEADER.
          ...
          05 SQLM-SIZE               PIC 9(9) COMP-5.
          05 VERSION                 PIC 9(9) COMP-5.
          05 EVENT-MONITOR-NAME      PIC X(20).
      ...
      *Statement Event
       01 SQLM-STMT-EVENT.
          ...
          05 INT-ROWS-INSERTED       PIC 9(9) COMP-5.
          05 STMT-EVENT-SQLCA.
             10 SQLM-SQLCAID         PIC X(8).
             10 SQLM-SQLCABC         PIC S9(9) COMP-5.
             10 SQLM-SQLCODE         PIC S9(9) COMP-5.
             10 SQLM-SQLERRM.
                15 SQLM-SQLERRML     PIC S9(4) COMP-5.
                15 SQLM-SQLERRMC     PIC X(70).
             10 SQLM-SQLERRP         PIC X(8).
             10 SQLM-SQLERRD        OCCURS 6 TIMES PIC S9(9) COMP-5.
             10 SQLM-SQLWARN.
                15 SQLM-SQLWARN0     PIC X.
                15 SQLM-SQLWARN1     PIC X.
                15 SQLM-SQLWARN2     PIC X.
                15 SQLM-SQLWARN3     PIC X.
                15 SQLM-SQLWARN4     PIC X.
                15 SQLM-SQLWARN5     PIC X.
                15 SQLM-SQLWARN6     PIC X.
                15 SQLM-SQLWARN7     PIC X.
                15 SQLM-SQLWARN8     PIC X.
                15 SQLM-SQLWARN9     PIC X.
                15 SQLM-SQLWARNA     PIC X.
             10 SQLM-SQLSTATE        PIC X(5).
          05 AGENT-ID                PIC 9(9) COMP-5.
          05 AGENTS-TOP              PIC 9(9) COMP-5.
          05 STMT-LENGTH             PIC 9(4) COMP-5.
          05 STMT-TEXT-OFFSET        PIC 9(4) COMP-5.
      ...
      *Deadlock Event
       01 SQLM-DEADLOCK-EVENT.
          ...
          05 START-TIME.
             10 SECONDS              PIC 9(9) COMP-5.
             10 MICROSEC             PIC 9(9) COMP-5.
          05 ROLLED-BACK-APPL-ID     PIC X(32).
          05 ROLLED-BACK-SEQUENCE-NO PIC X(4).

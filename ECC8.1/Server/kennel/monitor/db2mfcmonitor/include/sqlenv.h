...
#define SQLE_CLIENT_APPLNAME_MAX_LEN 255 /* Maximum client application        */
                                       /* information length                  */
#define SQLE_CLIENT_ACCTSTR_MAX_LEN 200 /* Maximum client accounting          */
                                       /* information length                  */
...
#define SQLE_RC_QUIESCE_FAILED -1371         /* Quiesce is failed             */
#define SQLE_RC_UNQUIESCE_FAILED -1373       /* Unquiesce is failed           */

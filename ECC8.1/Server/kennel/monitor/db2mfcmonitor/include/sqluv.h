...
typedef struct sqluboh
{
     ...
     sqluint32      objsize;              /* Size of the Object in bytes      */
     sqluint32      filesize;             /* Bytes in special files, pages    */
                                          /*   in data objects.               */
     ...
     char           objname[SQL_MAX_IDENT + SQL_MAX_IDENT + 2];
                                          /* "schema.tablename"               */
     sqluint16      flags;
     sqluint32      offset;               /* # of buffers into the file       */
     sqluint32      tableSpaceID;         /* Unique table space identifier    */

     /* Added in DB2 V8.1                                                     */
     sqluint32      originalSize;         /* Uncompressed objsize             */

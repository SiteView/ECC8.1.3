...
SVAPI_API
bool WriteIniFileString(string section,string key,string str,string filename,string addr)
{
...
SVAPI_API
bool WriteIniFileInt(string section,string key,int value,string filename,string addr)
{
	if(section.empty()||key.empty()||filename.empty()||addr.empty())
		return false;
	if((section.size()>MAXSECTIONLEN)||(key.size()>MAXKEYLEN))
...
SVAPI_API
bool WriteIniFileStruct(string section,string key, void *data,unsigned int len,string filename,string addr)
{
	if(section.empty()||key.empty()||filename.empty()||addr.empty())
		return false;
	if((section.size()>MAXSECTIONLEN)||(key.size()>MAXKEYLEN))
...
SVAPI_API
string GetIniFileString(string section,string key,string defaultret,string filename,string addr)
{
	if(section.empty()||key.empty()||filename.empty()||addr.empty())
		return defaultret;
	if((section.size()>MAXSECTIONLEN)||(key.size()>MAXKEYLEN))
...
SVAPI_API
int	GetIniFileInt(string section,string key,int defaultret,string filename,string addr)
{
	if(section.empty()||key.empty()||filename.empty()||addr.empty())
		return defaultret;
	if((section.size()>MAXSECTIONLEN)||(key.size()>MAXKEYLEN))
...
SVAPI_API
bool GetIniFileStruct(string section,string key,void *buf,unsigned int &len,string filename,string addr)
{
	if(section.empty()||key.empty()||filename.empty()||addr.empty())
		return false;
	if((section.size()>MAXSECTIONLEN)||(key.size()>MAXKEYLEN))
...
SVAPI_API
bool DeleteIniFileSection(string section,string filename,string addr)
{
...
SVAPI_API
bool DeleteIniFileKey(string section,string key,string filename,string addr)
{
	if(section.empty()||key.empty()||filename.empty()||addr.empty())
		return false;
	if((section.size()>MAXSECTIONLEN)||(key.size()>MAXKEYLEN))
...
SVAPI_API
bool GetIniFileSections(std::list<string> &sectionlist,string filename,string addr)
{
...
SVAPI_API
bool GetIniFileKeys(string section,std::list<string> &keylist,string filename,string addr)
{
...
SVAPI_API
int	GetIniFileValueType(string section,string key,string filename,string addr)
{
	if(filename.empty()||addr.empty()||section.empty())
...
SVAPI_API
bool EditIniFileSection(string oldsection,string newsection,string filename,string addr)
{
...
SVAPI_API
bool EditIniFileKey(string section,string oldkey,string newkey,string filename,string addr)
{
	if(section.empty()||filename.empty()||addr.empty())
		return false;

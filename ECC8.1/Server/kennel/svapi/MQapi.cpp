...
bool PushMessage(string queuename,string label,const char *data,unsigned int datalen,string user,string addr)
{
	...
	if(label.empty())
		label="defaultlabel";
	chen::TTime ct=chen::TTime::GetCurrentTimeEx();
...
SVAPI_API
bool PopMessage(string queuename,string &label,chen::TTime &createtime,char *databuf,unsigned int &buflen,unsigned int timer,string user,string addr)
{
...
SVAPI_API
bool BlockPopMessage(string queuename,string &label,chen::TTime &createtime,char *databuf,unsigned int &buflen,string user,string addr)
{
	if(queuename.empty()||(buflen<=0)||user.empty()||addr.empty())
		return false;
...
SVAPI_API
bool PeekMQMessage(string queuename,string &label,chen::TTime &createtime,char *databuf,unsigned int &buflen,unsigned int timer,string user,string addr)
{
	if(queuename.empty()||(buflen<=0)||user.empty()||addr.empty())
		return false;
...
SVAPI_API
bool BlockPeekMQMessage(string queuename,string &label,chen::TTime &createtime,char *databuf,unsigned int &buflen,string user,string addr)
{
	if(queuename.empty()||(buflen<=0)||user.empty()||addr.empty())
		return false;

...
void test23(string temp="")
{
	...
	PutValueInNodeData(ndata,"id","1.13.3.11");  //alertlogs
	PutValueInNodeData(ndata,"count","100" );
...
void test56(string temp="")
{
	...
	PutValueInNodeData(ndata,"end_year","2009" );
	PutValueInNodeData(ndata,"end_month","6" );
	PutValueInNodeData(ndata,"end_day","1" );
	PutValueInNodeData(ndata,"end_hour","10" );
	PutValueInNodeData(ndata,"end_minute","20" );
	PutValueInNodeData(ndata,"end_second","3" );
                                                        
	PutValueInNodeData(ndata,"begin_year","2006" );
	PutValueInNodeData(ndata,"begin_month","5" );
	PutValueInNodeData(ndata,"begin_day","1" );
	PutValueInNodeData(ndata,"begin_hour","7" );
	PutValueInNodeData(ndata,"begin_minute","5" );
	PutValueInNodeData(ndata,"begin_second","2" );

	//PutValueInNodeData(ndata,"id","1.27.6.1,1.27.7.1,1.27.136.12,1.27.136.17" );
	PutValueInNodeData(ndata,"id","5.6.1.13.211" ); //1.106.40.1
	...
	PutValueInNodeData(ndata,"return_value_filter","sv_primary,sv_drawimage" );
	PutValueInNodeData(ndata,"dstrStatusNoNeed","ok,warning" );

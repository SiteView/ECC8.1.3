...
//cxy 2012/07/13 snmpmonitor's 未测试
const char SV_PromptCMD[] = "_HoldCopy";
const char SV_TelPort[] = "_HoldCopy";
const char SV_TelPassword[] = "_HoldCopy";
const char SV_TelPrompt[] = "_HoldCopy";

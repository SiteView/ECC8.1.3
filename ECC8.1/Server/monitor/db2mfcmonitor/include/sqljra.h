 ...
 *  ===========================================================================
 *  140811   00/02/16 aam 64BIT: Change DB2R2/JRA eyecatchers for 64 bit
 *
 *****************************************************************************/
...
#define  SQLJRA_TTL64       "SQLJRA64"     /* SQLJRA title - 64BIT */   //@bd140811aam
#define  SQLJRA_TTL32       "SQLJRA  "     /* SQLJRA title - 32BIT */

/* NOTE: xxxxxxx_O eyecatchers are for  "O"ppositte word size */
#ifdef SQLO_ARCH_P64
#define  SQLJRA_TTL         SQLJRA_TTL64
#define SQLJRA_TTL_O        SQLJRA_TTL32
#else
#define  SQLJRA_TTL         SQLJRA_TTL32
#define SQLJRA_TTL_O        SQLJRA_TTL64
#endif                                                                  //@ed140811aam
...
typedef struct SQLJ_DBMON_TRIPLET
{
...
typedef struct sqljra
{
   ...
   sqluint32       sqlrabc;                /* Size in bytes                   */
   ...
   unsigned short  sqlrdnum;               /* Number of triplets              */
                                           /* SQLCA                           */
   sqluint32       sqlrcal;                /*   Length of SQLCA               */
   sqluint32       sqlrcat;                /*   Data type of SQLCA            */
   struct sqlca  * sqlrcap;                /*   Pointer to SQLCA              */
                                           /* Input SQLDA                     */
   sqluint32       sqlrdail;               /*   Length of input SQLDA         */
   sqluint32       sqlrdait;               /*   Data type of input SQLDA      */
   struct sqlda  * sqlrdapi;               /*   Pointer to input SQLDA        */
                                           /* Output SQLDA                    */
   sqluint32       sqlrdaol;               /*   Length of output SQLDA        */
   sqluint32       sqlrdaot;               /*   Data type of output SQLDA     */
   struct sqlda  * sqlrdapo;               /*   Pointer to output SQLDA       */
                                           /* Indicator array                 */
   sqluint32       sqlrflgl;               /*   Length of indicator array     */
   sqluint32       sqlrflgt;               /*   Data type of indicator array  */
   _SQLOLDCHAR    *sqlrflag;               /*   Pointer to indicator array    */
                                           /* Userid                          */
   sqluint32       sqlrusrl;               /*   Length of userid              */
   sqluint32       sqlrusrt;               /*   Data type of userid           */
   _SQLOLDCHAR   * sqlruser;               /*   Pointer to userid             */
                                           /* Database name                   */
   sqluint32       sqlrdbnl;               /*   Length of database name       */
   sqluint32       sqlrdbnt;               /*   Data type of database name    */
   _SQLOLDCHAR   * sqlrdbnm;               /*   Pointer to database name      */
                                           /* Package creator                 */
   sqluint32       sqlrcrel;               /*   Length of package creator     */
   sqluint32       sqlrcret;               /*   Data type of package creator  */
   _SQLOLDCHAR   * sqlrcrea;               /*   Pointer to package creator    */
                                           /* Section Number                  */
   sqluint32       sqlrsctl;               /*   Length of section number      */
   sqluint32       sqlrsctt;               /*   Data type of section number   */
   unsigned short *sqlrsect;               /*   Pointer to section number     */
                                           /* Package Name                    */
   sqluint32       sqlrpgml;               /*   Length of package name        */
   sqluint32       sqlrpgmt;               /*   Data type of package name     */
   _SQLOLDCHAR   * sqlrpgmn;               /*   Pointer to package name       */
                                           /* Consistency token               */
   sqluint32       sqlrctkl;               /*   Length of consistency token   */
   sqluint32       sqlrctkt;               /*   Data type of consistency token*/

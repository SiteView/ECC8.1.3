...
#define SQLA_CALL_RES_OPT      SQL_CALL_RES_OPT  /* Call resolution option    */
                                                 /* precompile option         */
#define SQLA_STATICREADONLY_OPT SQL_STATICREADONLY_OPT /* If static cursors   */
                                                 /* are to be treated as      */
                                                 /* READONLY                  */
#define SQLA_OPTPROFILE_OPT    SQL_OPTPROFILE_OPT /* The optimization         */
                                                 /* profile name              */
...
#define SQLA_EXPLAIN_ALL       SQL_EXPLAIN_ALL   /* EXPLAIN output produced   */
                                                 /* for all static and        */
                                                 /* dynamic statements.       */
#define SQLA_EXPLAIN_REOPT     SQL_EXPLAIN_REOPT /* EXPLAIN output produced   */
                                                 /* for static reoptimizable  */
                                                 /* statements.               */
...
#define SQLA_DYNAMICRULES_BIND SQL_DYNAMICRULES_BIND /* Dynamic SQL in        */
                                                 ...
                                                 /* package                   */
#define SQLA_DYNAMICRULES_INVOKE SQL_DYNAMICRULES_INVOKERUN /* Dynamic SQL    */
                                                 /* in UDF or stored          */
                                                 /* procedure will use        */
                                                 /* authid of invoker of UDF  */
                                                 /* or stored procedure       */
#define SQLA_DYNAMICRULES_DEFINE SQL_DYNAMICRULES_DEFINERUN /* Dynamic SQL    */
                                                 /* in UDF or stored          */
                                                 /* procedure will use        */
                                                 /* authid of definer of UDF  */
                                                 /* or stored procedure       */
#define SQLA_DYNAMICRULES_DEFINEBIND SQL_DYNAMICRULES_DEFINEBIND /* Dynamic   */
                                                 /* SQL in routine will use   */
                                                 /* authid of definer of      */
                                                 /* routine                   */
#define SQLA_DYNAMICRULES_DEFINERUN SQL_DYNAMICRULES_DEFINERUN /* Dynamic     */
                                                 /* SQL in routine will use   */
                                                 /* authid of definer of      */
                                                 /* routine                   */
#define SQLA_DYNAMICRULES_INVOKEBIND SQL_DYNAMICRULES_INVOKEBIND /* Dynamic   */
                                                 /* SQL in routine will use   */
                                                 /* authid of invoker of      */
                                                 /* routine                   */
#define SQLA_DYNAMICRULES_INVOKERUN SQL_DYNAMICRULES_INVOKERUN /* Dynamic     */
                                                 /* SQL in routine will use   */
                                                 /* authid of invoker of      */
                                                 /* routine                   */
...
#define SQLA_EXPLSNAP_ALL      SQL_EXPLSNAP_ALL  /* Save explain snapshot     */
                                                 /* for all static and        */
                                                 /* dynamic statements        */
#define SQLA_EXPLSNAP_REOPT    SQL_EXPLSNAP_REOPT /* Save explain snapshot    */
                                                 /* for static reoptimizable  */
                                                 /* statements                */
...
#define SQLA_QUERYOPT_1        SQL_QUERYOPT_1    /* Class 1 query             */
                                                 /* optimization              */
#define SQLA_QUERYOPT_2        SQL_QUERYOPT_2    /* Class 2 query             */
                                                 /* optimization              */
#define SQLA_QUERYOPT_3        SQL_QUERYOPT_3    /* Class 3 query             */
                                                 /* optimization              */
#define SQLA_QUERYOPT_5        SQL_QUERYOPT_5    /* Class 5 query             */
                                                 /* optimization              */
#define SQLA_QUERYOPT_7        SQL_QUERYOPT_7    /* Class 7 query             */
                                                 /* optimization              */
...
/* Values used for option[n].val when option[n].type is SQLA_STATICREADONLY   */
/* OPT in the Precompiler Option Array.                                       */
#define SQLA_STATICRO_NO       SQL_STATICRO_NO   /* Static cursors take on    */
                                                 /* attributes as would       */
                                                 /* normally be generated     */
                                                 /* given the statement text  */
                                                 /* and the LANGLEVEL option  */
#define SQLA_STATICRO_YES      SQL_STATICRO_YES  /* Any static cursor that    */
                                                 /* does not contain the FOR  */
                                                 /* UPDATE or FOR READ ONLY   */
                                                 /* clause will be            */
...
#define SQLA_ALLOC_INPUT                 3  /* Allocate an input SQLDA using  */
                                            /* SQLAALOC                       */
#define SQLA_ALLOC_OUTPUT                4  /* Allocate an output SQLDA       */
                                            /* using SQLAALOC                 */
#define SQLA_SETS                        5  /* Register a host variable       */
                                            /* using SQLASETS                 */
#define SQLA_USDA_INPUT                  6  /* Register an input user         */
                                            /* defined SQLDA                  */
#define SQLA_USDA_OUTPUT                 7  /* Register an output user        */
                                            /* defined SQLDA                  */
...
#define SQLA_SQLWARNING                  12 /* Generate code for WHENEVER     */
                                            /* SQLWARNING                     */
#define SQLA_NOT_FOUND                   13 /* Generate code for WHENEVER     */
                                            /* NOT_FOUND                      */
#define SQLA_INC_TEXTFILE                14 /* Process an INCLUDE text-file   */
                                            /* stmt                           */
...
#define SQLA_CMPD_TEST                   17 /* Generate a conditional branch  */
                                            /* around subsequent Compound     */
                                            /* SQL substatements.             */
#define SQLA_CMPD_MARK                   18 /* Generate a target label for    */
                                            /* gotos from cmpd_test           */
                                            /* (optional)                     */
#define SQLA_NEXT_SUBSTATEMENT           19 /* Request the outer precompiler  */
                                            /* to get the next triggered SQL  */
                                            /* statement                      */
#define SQLA_SQLCODE_COPY                20 /* Generate code to copy SQLCODE  */
                                            /* SQLSTATE                       */
#define SQLA_NEXT_STOREDPROC_STMT        21 /* Request the outer precompiler  */
                                            /* to get the next stored         */
                                            /* procedure SQL statement        */
#define SQLA_ASSOCIATE_LOCATOR           22 /* Generate code for ASSOCIATE    */
                                            /* LOCATOR                        */
#define SQLA_ASSOCIATE_PREV_PROC         23 /* Save last called procedure     */
                                            /* informationor generate code    */
                                            /* for ASSOCIATE LOCATOR          */
                                            /* referring to the last called   */
                                            /* procedure                      */
#define SQLA_ALLOCATE_CURSOR             24 /* Generate code for ALLOCATE     */
                                            /* CURSOR                         */
...
#define SQLA_CALLPROC                    42 /* SP SQL Deferred call           */
#define SQLA_CALLPROC_DEFERRED           42 /* SP Deferred call               */
...
#define SQLA_GETINFO                     74
#define SQLA_OPEN_WITH_RETURN            75
#define SQLA_OPEN_WITH_RETURN_TO_CLIENT  76
#define SQLA_CALLPROC_NEW                77
#define SQLA_CALLPROC_IMMED              77 /* SP Immediate call              */
#define SQLA_DESCRIBE_INPUT              78
#define SQLA_PREP_DESCRIBE_INPUT         79
#define SQLA_EXECUTE_FREE_LOB_LOCATORS   80
#define SQLA_SET_CURRENT_PKG_PATH        81 /* Set Current Package Path       */
/* The following two constants are for internal use only.  Do not use         */
/* them as values for sqlacall or similar API calls.                          */
#define SQLA_ALLOCATE                    82
#define SQLA_ASSOCIATE                   83
...
#define SQLA_TYPE_SET_CURRENT_PKG_PATH           195
...
#define SQL_PID_LENGTH_V610    40      /* length of precompiler pid for V6.1  */
                                       /* or earlier                          */
#define SQL_PID_LENGTH         162     /* length of precompiler pid           */
#define SQL_MIN_PID_LENGTH     34      /* minimum length of precompiler pid   */
...
#define SQLA_RC_CODEPAGE_BAD             -4995   /* Territory info not found  */
...
#define SQLAO_PREP_SVCS_API              0       /* Precompiler Services API  */
                                                 /* (sqlainit)                */
#define SQLAO_PREP_API                   1       /* Precompile API            */
                                                 /* (sqlaprep)                */
#define SQLAO_BIND_API                   2       /* Binder API (sqlabndx)     */
...
SQL_STRUCTURE sqla_program_id_V610
{
...
SQL_STRUCTURE sqla_program_id_v70
{
        unsigned short    length;
        unsigned short    rp_rel_num;
        unsigned short    db_rel_num;
        unsigned short    bf_rel_num;
        unsigned short    sqluser_len;
        char              sqluser[128];
        char              planname[8];
        char              contoken[8];
        char              buffer[8];
...
#define SQLA_PGMID_NETBIOS 5
#define SQLA_PGMID_DEFERRED_PREPARE 6
#define SQLA_INT_TO_ASCII_DIFF 48

/* Number of DUOW connection options                                          */
#define SQLA_PGMID_CONNOPTS 6
...
SQL_API_RC SQL_API_FN                      /* Add a host variable             */
  ...
  sqlaahvr (
        ...
        sqluint32 *,                       /* host variable token id          */
...
SQL_API_RC SQL_API_FN                      /* Add a host variable             */
  ...
  sqlaalhv (
        ...
        char *,                            /* host variable name              */
        unsigned short *,                  /* host variable SQL data type     */
        sqluint32 *,                       /* host variable length            */
        sqluint32 *,                       /* host variable token id          */
        unsigned short *,                  /* host variable location          */
        void *,                            /* reserved                        */
        struct sqlca *);                   /* SQLCA                           */
...
SQL_API_RC SQL_API_FN                      /* Initialize an access plan       */
  sqlainit (
        ...
        void *,                            /* precompiler program ID buffer   */
                                           /* length                          */
        struct sqlca *);                   /* SQLCA                           */
...
SQL_API_RC SQL_API_FN
  sqlgstls (
        sqluint32,                         /* SQL statement text length       */
        const void *,                      /* SQL statement text              */
        void *);                           /* reserved                        */
...
SQL_API_RC SQL_API_FN
  sqlgstlva (
        ...
        sqluint32,                         /* declared length                 */
        void *,                            /* address of host var             */
        sqluint32,                         /* declared struct type length     */
        void *,                            /* address of struct type name     */
        short *,                           /* address of indicator var        */
        void *);                           /* reserved                        */

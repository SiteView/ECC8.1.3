...
#include "C:\SiteView\Ecc_Common\snmp++\include\snmp_pp\snmp_pp.h"
...
public:
    unsigned long   AvgValue(const MonitorResult &ResultList);
    unsigned long   MaxValue(const MonitorResult &ResultList);
    unsigned long   MinValue(const MonitorResult &ResultList);

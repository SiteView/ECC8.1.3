// FSUrlMonitor.cpp : 定义 DLL 的初始化例程。
//

#include "stdafx.h"
#include "FSUrlMonitor.h"
#include <fstream>
#include <iostream>
using namespace std;
...
BEGIN_MESSAGE_MAP(CFSUrlMonitorApp, CWinApp)
END_MESSAGE_MAP()


// CFSUrlMonitorApp 构造

CFSUrlMonitorApp::CFSUrlMonitorApp()
{
	// TODO: 在此处添加构造代码，
...
// 唯一的一个 CFSUrlMonitorApp 对象

CFSUrlMonitorApp theApp;


// CFSUrlMonitorApp 初始化

BOOL CFSUrlMonitorApp::InitInstance()
{
...
bool PrintLog(const char * strParas)
{
		...
		ofstream FileStream;
		FileStream.open("FSURLMonitor.log",ios::app);

// WeatherMonitor.h : main header file for the ORACLE DLL
//
...
/////////////////////////////////////////////////////////////////////////////
// CWeatherMonitorApp
// See WeatherMonitor.cpp for the implementation of this class
//

class CWeatherMonitorApp : public CWinApp
{
public:
	CWeatherMonitorApp();
...
// Overrides
	...
	//{{AFX_VIRTUAL(CWeatherMonitorApp)
	//}}AFX_VIRTUAL

	//{{AFX_MSG(CWeatherMonitorApp)

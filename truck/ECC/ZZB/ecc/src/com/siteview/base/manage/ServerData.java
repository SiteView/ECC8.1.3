...
{
	private static final List<String> m_tree_index = new CopyOnWriteArrayList<String>();
	private static final Map<String, String> m_son_id = new ConcurrentHashMap<String, String>	();
	private static final Map<String, Map<String, String>> m_tree_map = new ConcurrentHashMap<String, Map<String, String>>();

	// <index of ini , >
	private static final Map<String, Map<String, String>> m_user_ini = new ConcurrentHashMap<String, Map<String, String>>();
	private static final Map<String, IniFile> m_user_ini_publish = new ConcurrentHashMap<String, IniFile>();

	// <LoginName, index of ini>
	private static final Map<String, String> m_name_index =  new ConcurrentHashMap<String, String>();

	private static final Map<String, Object> m_other_data =new ConcurrentHashMap<String, Object>();
	
	
	private static final void setSonId()
	{
...
//				logger.info(key+"'s son_id: "+son_id.get(key));
	...
	public static final SeNode[] getSe(String LoginName)
	{
	...
	public static final SeNode getSeNode(String LoginName, String id)
	{
	...
	public static final GroupNode getGroupNode(String LoginName, String id)
	{
		if(LoginName==null || id==null || LoginName.isEmpty() || id.isEmpty())
			return null;
		if(!canVisitNode(LoginName,id) || !m_tree_map.containsKey(id))
	...
	public static final EntityNode getEntityNode(String LoginName, String id)
	{
		if(LoginName==null || id==null || LoginName.isEmpty() || id.isEmpty())
			return null;
		if(!canVisitNode(LoginName,id) || !m_tree_map.containsKey(id))
	...
	public static final MonitorNode getMonitorNode(String LoginName, String id)
	{
		if(LoginName==null || id==null || LoginName.isEmpty() || id.isEmpty())
			return null;
		if(!canVisitNode(LoginName,id) || !m_tree_map.containsKey(id))
	...
	public static final INode getNode(String LoginName, String id)
	{
		if(LoginName==null || id==null || LoginName.isEmpty() || id.isEmpty())
			return null;
		if(!canVisitNode(LoginName,id) || !m_tree_map.containsKey(id))
	...
	public static final Map<String, String> getRawMapClone(String id)
	{
	...
	public static final String getSonId(String id)
	{
		if(id==null || id.isEmpty())
			return "";		
	...
	public static final boolean isAdmin(String LoginName)
	{
	...
	public static final IniFile getUserIni(String LoginName)
	{
		if(LoginName==null)
			return null;
		String index= m_name_index.get(LoginName);
	...
	public static final Map<String, IniFile> getAllUserIni()
	{
		Map<String, IniFile> a= new HashMap<String, IniFile>(m_user_ini_publish);
		return a;
	}
	
	public static final Map<String, String> getIniValue(String LoginName, String id)
	{
		if(LoginName==null || id==null || LoginName.isEmpty() || id.isEmpty())
			return null;
		String index= m_name_index.get(LoginName);
	...
	public static final boolean canVisitNode(String LoginName, String id)
	{
		if(LoginName==null || id==null || LoginName.isEmpty() || id.isEmpty())
			return false;
		String index= m_name_index.get(LoginName);
	...
	public static final void updateUserIni(RetMapInMap userini)
	{
	...
	public static final List<Map<String, String>> getRawTreeData()
	{
	...
	public static final void updateTreeData(RetMapInVector tree,  Map<String, Map<String, String>> plusInfo)
	{
	...
	private static final void setPlusInfo(String id, Map<String, String> ndata, Map<String, Map<String, String>> plusInfo)
	{
...
//		set_sv_dependson_svname(ndata);
	...
	private static final void setTreeDelete(TreeSet<String> index)
	{
		for (String id : index)
		{
	...
	public static final boolean setCRUDofNode(String LoginName, INode node) throws Exception
	{		
	...
	private static final boolean setUserIniValue(String section, String key, String value, INode node) throws Exception
	{
	...
	private static final int getValueInRMap(Map<String, String> rmap, String key)
	{
	...
	private static final void setUsedPointAndNetWork()
	{
		int pointUsed=0;
		int networkUsed=0;
	...
	public static final Integer getPointUsed()
	{
		Integer i= -1;
		try
		{
	...
	public static final Integer getNetWorkUsed()
	{
	...
	public static final void getAdminNamePWD(StringBuilder name, StringBuilder pwd)
	{

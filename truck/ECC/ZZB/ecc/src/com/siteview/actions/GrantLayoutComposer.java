...
public class GrantLayoutComposer extends GenericForwardComposer implements
	...
	public void doAfterCompose(Component comp) throws Exception {
		...
		applyActionGrant.addEventListener("onClick", new EventListener() {
			...
			public void onEvent(Event event) throws Exception {
				...
				{
					Messagebox.show("管理员无需授权，总是拥有全部功能!", "提示", Messagebox.OK,Messagebox.INFORMATION);
					return;
				}
				try
				{
					commitActionGrant();
					Messagebox.show("成功!", "提示", Messagebox.OK,Messagebox.INFORMATION);
				}catch(Exception e)
				{
	...
	private void refreshActionCheck() {
		checkAll.setChecked(false);//增加初始化 状态设置
...
/*		if (dispPanel_report("Report")){
	...
	private void commitActionGrant_special(EccTreeItem eccTreeItem) throws Exception
	{

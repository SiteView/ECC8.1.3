...
public class MonitorFilter {
	...
	public String showAndHidden(){//ok,warning,error,bad,null,disable,time_disable
		...
		if(this.hiddenAndShow.equals("showErrorWarnning")){
			return "warning,error";//return "bad,warning,error";
		}else if(this.hiddenAndShow.equals("showError")){
			return "error";//return "bad,error";
			...
			return "disable,time_disable";//return "disable";
			...
			return "time_disable,ok,disable,null,bad";//return "time_disable,ok,disable,null";
		}else if(this.hiddenAndShow.equals("hideError")){
			return "ok,warning,null,disable,time_disable,bad";//return "ok,warning,null,disable,time_disable";
		...
		}else if(this.hiddenAndShow.equals("hideBad")){//隐藏定义错误
			return "ok,warning,error,null,time_disable";
		}else if(this.hiddenAndShow.equals("hideForbid")){
			return "ok,warning,error,bad,null";//return "ok,warning,error,bad,null,time_disable";
		}else if(this.hiddenAndShow.equals("hideForeverForbid")){
			return "ok,warning,error,bad,null,time_disable";//return "ok,warning,error,bad,null,disable";
		}else if(this.hiddenAndShow.equals("hideTemporaryForbid")){
			return "ok,warning,error,bad,null,disable";//return "ok,warning,error,bad,null,disable";
		}
		return "";
	}

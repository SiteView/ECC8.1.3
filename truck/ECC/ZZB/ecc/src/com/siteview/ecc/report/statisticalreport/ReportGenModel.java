...
//		}
	...
	public void onClickSimplemonitorreportslistbox(Event event)
		...
		String downLoadUrl=StatsReport.getDownLoadUrl(reportGenItem.getGenID(),fileType);
...
//			String htmlurl = Constand.statreportsavepath + fileName	+ File.separator ;
			String htmlurl = StatsReport.getHtmlFolderName(reportGenItem.getGenID());
...
//				win.showUrl("D:\\20090925_1253868441109\\20090925_12538684411091.html");
				win.showUrl("/main/report/showStatisticReport.jsp?reportGenID="+reportGenItem.getGenID()+"&currentPage=1");
				win.doModal();
			}else{
				return;
			}
	...
	public void render(Listitem parent, Object data) throws Exception 
	{
		...
		img.addEventListener("onClick", new EventListener(){
			...
			public void onEvent(Event event) throws Exception {
				...
				reportComposer.deleteReportFile(reportGenItem.getGenID(), reportGenItem.getFileType());

...
ComposerExt ,ListitemRenderer {
		...
		btnBatchDeleteGen.addEventListener("onClick", new EventListener(){
			...
			public void onEvent(Event event) throws Exception {
				...
				while(iterator.hasNext())
				{
					...
					deleteReportFile(reportGenItem.getGenID(), reportGenItem.getFileType());
	 ...
	 * 1244550912926.html
	 */
	public void deleteReportFile(String genid,String fileType)
	{
		
		String pathFile=StatsReport.getCreateFile(genid, fileType);
			...
			{		
				...
				if(reportGemIni!=null)
				{
					...
					{	
						...
						deleteReportFile(genID,fileType);
					}
				}
			}

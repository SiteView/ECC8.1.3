...
<script type="text/jscript" language="jscript">
	...
	function load()
	{
		...
		viewMgr.visBBoxLeft = -0.590551;
		viewMgr.visBBoxRight = 9.566929;
		viewMgr.visBBoxBottom = 2.806553;
		viewMgr.visBBoxTop = 9.447983;
...
<v:shape type="#VISSHAPE"  href="#" fillcolor="SV_Group:开封+color" tabindex="1" title="开封" origTitle="开封"  style="top:-1000;left:-1000;width:3059;height:2000;position:absolute" path=" m 846,-247 l 846,-180 l 946,-180 l 946,-247 l 846,-247xe" onmouseover="UpdateTooltip(this,0,6)" onclick="OnShapeClick(0,6)" onfocus="UpdateTooltip(this,0,6);" onkeyup="OnShapeKey(0,6)"/> 

<v:shape type="#VISSHAPE"  href="#" fillcolor="SV_Group:周口+color" tabindex="1" title="周口" origTitle="周口"  style="top:-1000;left:-1000;width:3059;height:2000;position:absolute" path=" m 964,48 l 964,115 l 1064,115 l 1064,48 l 964,48xe" onmouseover="UpdateTooltip(this,0,17)" onclick="OnShapeClick(0,17)" onfocus="UpdateTooltip(this,0,17);" onkeyup="OnShapeKey(0,17)"/> 

<v:shape type="#VISSHAPE"  href="#" fillcolor="SV_Group:南阳+color" tabindex="1" title="南阳" origTitle="南阳"  style="top:-1000;left:-1000;width:3059;height:2000;position:absolute" path=" m 174,308 l 174,376 l 274,376 l 274,308 l 174,308xe" onmouseover="UpdateTooltip(this,0,18)" onclick="OnShapeClick(0,18)" onfocus="UpdateTooltip(this,0,18);" onkeyup="OnShapeKey(0,18)"/> 

...
//				System.out.println("parameter中的值1  title		"+sb.toString());
//				System.out.println("parameter中的值2  subtitle		"+Toolkit.getToolkit().formatDate(beginDate)+"~"+Toolkit.getToolkit().formatDate(endDate));
//				System.out.println("parameter中的值3  SUBREPORT_DIR		"+subDir);
//				System.out.println("parameter中的值4  ds1		"+new ComparereportDatasource(l1));
//				System.out.println("parameter中的值5  ds2		"+new ComparereportDatasource(l2));
